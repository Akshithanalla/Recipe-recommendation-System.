...
def fileUpload():
    ...
    data_dir = 'C:/Users/user/Downloads/Homemade-RecipeBowl-Your-Ingredients-Our-Recipes-master (1)/Homemade-RecipeBowl-Your-Ingredients-Our-Recipes-master/Website/api/data'
